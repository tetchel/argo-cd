...
func (m *RefsList) Reset()         { *m = RefsList{} }
func (m *RefsList) String() string { return proto.CompactTextString(m) }
func (*RefsList) ProtoMessage()    {}
func (*RefsList) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd8723cfcc820480, []int{3}
}
func (m *RefsList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RefsList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RefsList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RefsList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefsList.Merge(m, src)
}
func (m *RefsList) XXX_Size() int {
	return m.Size()
}
func (m *RefsList) XXX_DiscardUnknown() {
	xxx_messageInfo_RefsList.DiscardUnknown(m)
}

var xxx_messageInfo_RefsList proto.InternalMessageInfo

func (m *RefsList) GetBranches() []string {
	if m != nil {
		return m.Branches
	}
	return nil
...
func (m *RefsList) GetTags() []string {
	if m != nil {
		return m.Tags
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RefsList)(nil), "repository.RefsList")
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *RefsList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RefsList) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RefsList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RefsList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RefsList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RefsList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
